...
namespace VaultApi.Common.Migrations
{
    ...
    [Migration("20201002084705_TransferValidationRequestsRenameFields_1")]
    partial class TransferValidationRequestsRenameFields_1
    {
            ...
            modelBuilder.Entity("VaultApi.Common.ReadModels.TransferValidationRequests.TransferValidationRequest", b =>
                {
                    ...
                    b.Property<string>("SiriusSignature")
                        .HasColumnType("text");
